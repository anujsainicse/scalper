...
This demonstrates the new exchange integration system
"""
...
async def test_buy_eth():
    """Test buying 1 ETH at $3800"""

    print("=" * 60)
    print("CoinDCX Futures - Buy 1 ETH at $3800")
    print("=" * 60)
    ...
    try:
        ...
        print(f"{'='*60}")
        print(f"You are about to place a REAL order on CoinDCX Futures:")
        ...
        print(f"\nType 'YES' to confirm or anything else to cancel: ", end="")
